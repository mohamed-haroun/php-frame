...
<div class="container">
    ...
    <?php endif;?>
    <div class="w-50 mx-auto my-5 p-5 shadow border rounded">
        <div class="mb-3">
...
<form method="post" action="/login">
    <div class="mb-3">
        ...
        <input type="email"
               class="form-control  <?php echo isset($email_message) ? 'is-invalid' : ''?>"
               name="email"
    ...
    <div class="mb-3">
        ...
        <input type="password"
               class="form-control <?php echo isset($password_message) ? 'is-invalid' : ''?>"
               name="password"
    ...
    <button type="submit" class="btn btn-primary w-100">Login</button>
        ...
        <p class="text-center mt-5 mb-0">Don't have an account yet? <a href="/register" class="text-primary fw-bold">Sign Up</a></p>
    </div>
</div>